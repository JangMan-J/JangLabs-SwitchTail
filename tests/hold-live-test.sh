...
echo "== panes at start =="
Q ls | python3 /tmp/hold_q.py list
claude_id="$(Q ls | python3 /tmp/hold_q.py idof CLAUDE)"
shell_id="$(Q ls | python3 /tmp/hold_q.py idof SHELL)"
